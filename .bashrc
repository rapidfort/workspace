...
alias public_ecr='_pub_ecr() {
    aws ecr-public get-login-password --region us-east-1 | docker login --username AWS --password-stdin public.ecr.aws/rapidfort
}; _pub_ecr'

alias ecr='_ecr() {
    aws ecr get-login-password | docker login --username AWS --password-stdin 274057717848.dkr.ecr.us-east-1.amazonaws.com
}; _ecr'
